...
var PolygonService *PolygonGRPCService

type PolygonGRPCService struct {
	pbClient pb.PolygonServiceClient
}

func (c *PolygonGRPCService) IsWaitingPermit(wallet string) (bool, error) {
...
func (c *PolygonGRPCService) GetBalance(tokenAddress, walletAddress string) (*big.Int, error) {
...
func (c *PolygonGRPCService) GetAllowance(ownerAddress, spenderAddress, tokenAddress string) (*big.Int, error) {
